        ...
        <SafeAreaView style={{ backgroundColor: "white", flex: 1 }}>
            <View style={styles.Container}>
                ...
                <View style={styles.loginb}>
                    ...
                    }} onPress={LoginButton}>Login</Text>
                </View>
...
const styles = StyleSheet.create({
    ...
    Container: { justifyContent: "center", alignItems: 'center', flexDirection: 'column', flex: 1, paddingHorizontal: 55 },
    login: { flexDirection: 'row', backgroundColor: "#F6F6F6", marginBottom: 14, alignItems: 'center', height: windowWidth/10 },
    form: { flexDirection: 'column', alignItems: "center" },
